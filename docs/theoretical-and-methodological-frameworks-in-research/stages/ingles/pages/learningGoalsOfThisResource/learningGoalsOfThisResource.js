class inglesClass_learningGoalsOfThisResource extends generalPage{
  ...
  content(){
      ...
      <div class="text-show-content">
            <p>The purpose of this virtual learning object is to provide conceptual and procedural knowledge to understand how to build up the theoretical and the methodological frameworks of a research project within the field of educational research.</p>
      </div>
      `;
  }
  importCssFiles(){
