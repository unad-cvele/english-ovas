class importCustomJS {
    constructor(url = '.',version = '1', name){
...
/*    remove(file){
    ...
    statusOfLoad(script){
        ...
        script.onload = function() {
            console.log(`- ${these.jsImportName}`);
...
const importJS = new importCustomJS(configuration.globalURL,configuration.version,'JS - general');
